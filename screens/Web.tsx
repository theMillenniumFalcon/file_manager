...
import { View, StyleSheet, TextInput, TouchableOpacity, Keyboard, BackHandler } from 'react-native'
...
const Web: React.FC = () => {
    ...
    const upgradeURL = (uri: string, searchEngine = 'google') => {
        ...
        return searchEngines[searchEngine as keyof searchEnginesObjectType](encodedURI)
    }
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <WebView
                allowsLinkPreview
                ref={browserRef as React.MutableRefObject<WebView<{}> | null>}
                source={{ uri: target }}
