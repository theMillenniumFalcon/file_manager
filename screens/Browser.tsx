...
import { View, StyleSheet, FlatList, TouchableOpacity, Platform, Alert, BackHandler, TextInput } from 'react-native'
...
import { ExtendedAsset, fileItem } from '../types/types'
                ...
                if (currentDir !== route?.params?.prevDir) {
                    ...
                    Promise.all(filesProms).then((results) => {
                        ...
                        const tempImageFiles = results.filter((file) => {
                            let fileExtension = file.uri.split('/').pop()!.split('.').pop()!.toLowerCase()
    ...
    return (
        <View style={{ ...styles.container, backgroundColor: colors.background }}>
            <ActionSheet
                ...
                numberOfLinesTitle={(undefined) as any}
