...
import { fileIcons, fileIconsObjectType } from '../../../utils/Constants'
            ...
            case 'application':
                return (
                    <MaterialCommunityIcons
                        name={fileIcons[itemFormat as keyof fileIconsObjectType] || 'file-outline'}
                        size={35}
    ...
    return (
        <View style={styles.container}>
            <ActionSheet
                ...
                numberOfLinesTitle={multiSelect ? undefined as unknown as number : 1}
